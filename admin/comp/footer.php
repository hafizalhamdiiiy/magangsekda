  ...
  <section class="p-t-60 p-b-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> Sekretariat Daerah Kab. Pati. All rights reserved. Template by <a href="https://colorlib.com">Sekretariat Daerah</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
